...
(
    ...
    CONSTRAINT FK_TB_BLOG_TO_TB_BOARD_1 FOREIGN KEY (BLOG_ID) REFERENCES TB_BLOG (BLOG_ID)
);
...
(
    ...
    CONSTRAINT FK_TB_BLOG_TO_TB_FOLLOW_1 FOREIGN KEY (FOLLOWED_BLOG_ID) REFERENCES TB_BLOG (BLOG_ID) ON DELETE CASCADE,
    CONSTRAINT FK_TB_BLOG_TO_TB_FOLLOW_2 FOREIGN KEY (FOLLOWER_BLOG_ID) REFERENCES TB_BLOG (BLOG_ID) ON DELETE CASCADE
);
